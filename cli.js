...
const returnCertPath = path.resolve(process.cwd(), 'certs');
 ...
 * (Static Method)
 */
cli.mergeArgs = function (configPath, profilePath, _certDir) {
    // Merge down everything
    return Object.assign(this.getCertDir(_certDir), this.getConfig(configPath), this.getProfiles(profilePath), argsCLI);
};
...
module.exports = (async () => {
    ...
    if (argsCLI.init) {
        ...
        const finalArgs = argsCLI.configPath
